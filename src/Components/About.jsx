    ...
    <>
      ...
      <div className="relative min-h-[80vh] overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-4 sm:px-6 py-16 text-center">
          ...
          <h1 className="font-display text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-[#111] tracking-tightish mb-6 leading-[1.05]">
            About{" "}
          ...
          <div className="bg-white border border-[#e5e5e5] rounded-2xl shadow-sm p-5 sm:p-8 max-w-2xl mx-auto">
